...
select * from humanos;
select nome from humanos where grupo = 'a';
select nome from humanos where cor_favorita = 'azul';
select nome from humanos where clube = 'alpha';
select nome from humanos where profissao = 'motorista';
select nome from humanos where nacionalidade = 'brasileira';
select nome from humanos where sexo = 'f';
select nome from humanos where filme = 'milagre';